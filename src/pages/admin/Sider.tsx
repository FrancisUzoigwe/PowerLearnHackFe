    ...
    <div className="small:hidden">
      {toggle ? (
        <div className="h-[100vh] w-[65px] fixed bg-[#69BA00] text-white pt-[10px]">
          <div className=" flex flex-col w-full h-[90px] hover:bg-[#85bc3c] hover:text-[black] items-center justify-between px-[5px] hover:cursor-pointer transition-all duration-300 hover:rounded-md">
